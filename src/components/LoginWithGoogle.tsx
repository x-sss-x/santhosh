...
const LoginWithGoogle = () => {
  ...
  return (
    <button className=" w-64 xs:w-56 xs:text-sm bg-neutral-200 text-black font-bold py-2 px-6 border border-black hover:bg-neutral-400 rounded-xl flex items-center">
      <div className="mr-2">
